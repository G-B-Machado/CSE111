...
pressure_loss_from_fittings, reynolds_number, pressure_loss_from_pipe_reduction, convert_kpa_to_psi)
import pytest
...
def test_pressure_gain_from_water_height():
    assert pressure_gain_from_water_height(0) == approx(0.0, abs = 0.001)
...
def test_convert_kpa_to_psi():
    assert convert_kpa_to_psi(153.9) == approx(22.3, abs=0.1)
